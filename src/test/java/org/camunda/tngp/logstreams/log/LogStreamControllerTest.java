...
public class LogStreamControllerTest
{
    ...
    @Mock
    private ScheduledTask mockScheduledSendBuffer;
    ...
    public void init() throws Exception
    {
        ...
        when(mockTaskScheduler.submitTask(mockWriteBufferConductor)).thenReturn(mockScheduledSendBuffer);
    ...
    public void shouldOpen()
    {
        ...
        verify(mockTaskScheduler).submitTask(controller);
    ...
    public void shouldNotOpenIfNotClosed()
    {
        ...
        verify(mockTaskScheduler, times(1)).submitTask(controller);
        verify(mockTaskScheduler, times(1)).submitTask(mockWriteBufferConductor);
    }
    ...
    public void shouldClose()
    {
        ...
        verify(mockScheduledSendBuffer).remove();

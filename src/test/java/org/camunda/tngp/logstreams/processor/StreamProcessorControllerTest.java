...
public class StreamProcessorControllerTest
{
    ...
    public void init() throws Exception
    {
        ...
        when(mockTaskScheduler.submitTask(any())).thenReturn(mockScheduledTask);
    ...
    public void shouldOpen()
    {
        ...
        verify(mockTaskScheduler).submitTask(any(StreamProcessorController.class));
    ...
    public void shouldNotOpenIfNotClosed()
    {
        ...
        verify(mockTaskScheduler, times(1)).submitTask(any(StreamProcessorController.class));
    ...
    public void shouldCloseWhilePollEvents()
    {
        ...
        verify(mockScheduledTask).remove();
    }
